...
public class DesktopApplication1View extends FrameView {
    ...
    public void newRecord() {
        desktopapplication1.Genero g = new desktopapplication1.Genero();
    ...
    public void deleteRecord() {
        ...
        List<desktopapplication1.Genero> toRemove = new ArrayList<desktopapplication1.Genero>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            desktopapplication1.Genero g = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(g);
    ...
    private class SaveTask extends Task {
        ...
        @Override protected Void doInBackground() {
            try {
                ...
                rex.printStackTrace();
                entityManager.getTransaction().begin();
                List<desktopapplication1.Genero> merged = new ArrayList<desktopapplication1.Genero>(list.size());
                for (desktopapplication1.Genero g : list) {
    ...
    private java.util.List<desktopapplication1.Genero> list;
