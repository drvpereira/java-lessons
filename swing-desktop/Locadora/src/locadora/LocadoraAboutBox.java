...
public class LocadoraAboutBox extends javax.swing.JDialog {

    public LocadoraAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(locadora.LocadoraApp.class).getContext().getResourceMap(LocadoraAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(locadora.LocadoraApp.class).getContext().getActionMap(LocadoraAboutBox.class, this);
