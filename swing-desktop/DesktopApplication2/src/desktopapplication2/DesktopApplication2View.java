...
public class DesktopApplication2View extends FrameView {
    ...
    public void newRecord() {
        desktopapplication2.Cliente c = new desktopapplication2.Cliente();
    ...
    public void deleteRecord() {
        ...
        List<desktopapplication2.Cliente> toRemove = new ArrayList<desktopapplication2.Cliente>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            desktopapplication2.Cliente c = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(c);
    ...
    private class SaveTask extends Task {
        ...
        @Override protected Void doInBackground() {
            try {
                ...
                rex.printStackTrace();
                entityManager.getTransaction().begin();
                List<desktopapplication2.Cliente> merged = new ArrayList<desktopapplication2.Cliente>(list.size());
                for (desktopapplication2.Cliente c : list) {
    ...
    private void initComponents() {
        ...
        nascimentoLabel.setText(resourceMap.getString("nascimentoLabel.text")); // NOI18N
        ...
        mainPanelLayout.setHorizontalGroup(
            ...
            .add(mainPanelLayout.createSequentialGroup()
                ...
                .add(mainPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(nascimentoField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE))
                .addContainerGap())
            .add(mainPanelLayout.createSequentialGroup()
                .addContainerGap()
        ...
        mainPanelLayout.setVerticalGroup(
            ...
            .add(mainPanelLayout.createSequentialGroup()
                ...
                .add(mainPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(nascimentoLabel)
                    .add(nascimentoField, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(mainPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(saveButton)
                    .add(refreshButton)
    ...
    private java.util.List<desktopapplication2.Cliente> list;
